...
namespace Obd2Net.Tests
{
    public class DecoderTests
    {
        ...
        {
            Decoders.Pid(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<string>(result, unit));
        }
        ...
        {
            Decoders.Count(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<int>(result, unit));
        }
        ...
        {
            Decoders.Percent(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Percent_centered(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Temp(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<int>(result, unit));
        }
        ...
        {
            Decoders.Catalyst_temp(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Current_centered(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Sensor_voltage(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Sensor_voltage_big(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Fuel_pressure(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<uint>(result, unit));
        }
        ...
        {
            Decoders.Pressure(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<uint>(result, unit));
        }
        ...
        {
            Decoders.Fuel_pres_vac(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Fuel_pres_direct(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<int>(result, unit));
        }
        ...
        {
            Decoders.Abs_evap_pressure(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Evap_pressure_alt(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<int>(result, unit));
        }
        ...
        {
            Decoders.Rpm(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Speed(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Timing_advance(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Inject_timing(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<int>(result, unit));
        }
        ...
        {
            Decoders.Maf(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Max_maf(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<uint>(result, unit));
        }
        ...
        {
            Decoders.Seconds(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<uint>(result, unit));
        }
        ...
        {
            Decoders.Minutes(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<uint>(result, unit));
        }
        ...
        {
            Decoders.Distance(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<uint>(result, unit));
        }
        ...
        {
            Decoders.Fuel_rate(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<decimal>(result, unit));
        }
        ...
        {
            Decoders.Fuel_status(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<string>(result, unit));
        }
        ...
        {
            Decoders.Air_status(Message.FromHexString(hex)).ShouldBeEquivalentTo(new DecoderValue<string>(result, unit));
        }
        ...
        {
            Decoders.Elm_voltage(new Message(new Frame(raw))).ShouldBeEquivalentTo(new DecoderValue<decimal?>(result, unit));
        }
